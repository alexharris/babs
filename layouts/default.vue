<template>
  <div class="flex flex-col h-screen">
    ...
    <div class="py-2 px-4 justify-between w-full z-50 flex flex-row">  
      
      <div class="w-1/3">
        <GoBack  v-if="this.$route.path !== '/'" />
      </div>
      <!-- <svg v-if="this.$route.path !== '/'" class="w-16" viewBox="0 0 336 169" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="w-1/3 text-right"><Menu /></div>
    </div>
